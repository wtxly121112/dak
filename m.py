...
from pyrogram.raw import functionsif
...
with Client("my_account") as app:
    while True:
        time.sleep(3)
        app.send(functions.account.UpdateProfile(first_name="qweeffe"))
        time.sleep(3)
        app.send(functions.account.UpdateProfile(first_name="qweeff"))
        time.sleep(3)
        app.send(functions.account.UpdateProfile(first_name="qweef"))
        time.sleep(3)
        app.send(functions.account.UpdateProfile(first_name="qweeff"))
        time.sleep(3)
        app.send(functions.account.UpdateProfile(first_name="qweef"))
        time.sleep(3)
        app.send(functions.account.UpdateProfile(first_name="qwee"))
        time.sleep(3)
        app.send(functions.account.UpdateProfile(first_name="qwe"))
        time.sleep(3)
        app.send(functions.account.UpdateProfile(first_name="qw"))
        time.sleep(3)
        app.send(functions.account.UpdateProfile(first_name="q"))
        time.sleep(3)
        app.send(functions.account.UpdateProfile(first_name="qw"))
        time.sleep(3)
        app.send(functions.account.UpdateProfile(first_name="qwe"))
        ...
        app.send(functions.account.UpdateProfile(first_name="qweef"))
        time.sleep(3)
        app.send(functions.account.UpdateProfile(first_name="qweff"))
        time.sleep(3)
        app.send(functions.account.UpdateProfile(first_name="qweeffe"))
